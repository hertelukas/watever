...
class IRGenContext {
  ...
  Wasm doTree(llvm::BasicBlock *Root, Context &Ctx, llvm::DominatorTree &DT);
  Wasm doBranch(llvm::BasicBlock *TrueBlock, llvm::BasicBlock *FalseBlock,
                Context &Ctx);

  // TODO MergeChildren needs better type
  Wasm nodeWithin(llvm::BasicBlock *Parent,
